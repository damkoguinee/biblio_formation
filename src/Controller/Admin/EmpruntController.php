...
class EmpruntController extends AbstractController
{
    ...
    public function index(EmpruntRepository $empruntRepository): Response
    {
        return $this->render('admin/emprunt/index.html.twig', [
            // 'emprunts' => $empruntRepository->findAll(), identique avec la ligne en dessous avec plus des critères
            'emprunts' => $empruntRepository->findBy([], ["dateEmprunt" =>"DESC", "dateRetour"=>"ASC"]),
        ]);
    }
